...
import { Lock, User as UserIcon, ArrowRight, ShieldCheck, UserPlus } from 'lucide-react';
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="flex justify-center mb-6">
          <div className="bg-white p-3 rounded-2xl shadow-sm border border-gray-100 inline-flex items-center justify-center">
            <UserPlus className="h-10 w-10 text-[#004DB3]" strokeWidth={1.5} />
          </div>
        </div>
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Join the Payroll Calculator system
        </p>
      </div>
          ...
          <form className="space-y-6" onSubmit={handleRegister}>
            ...
            <div className="text-center mt-4">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/login" className="font-medium text-[#004DB3] hover:text-[#003882] transition-colors">
                  Sign In
                </Link>
              </p>
            </div>
